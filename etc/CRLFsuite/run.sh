#!/bin/bash
#This script runs CRLFsuite tool
...
OUTPUT_FILENAME="CRLFsuite.out.${sanitized_url::64}.$(date +'%Y_%m_%dT%H_%M_%S').txt"
...
#run:
crlfsuite -t "${url}" -cL -sL -oN "${OUTPUT_EXPLOITING_FOLDER}/${OUTPUT_FILENAME}"
