...
OUTPUT_FILENAME="whatweb.out.${sanitized_url::64}.$(date +'%Y_%m_%dT%H_%M_%S').txt"
...
#run:
whatweb -a 3 ${url} > "${OUTPUT_SCANNING_FOLDER}/${OUTPUT_FILENAME}"
