...
OUTPUT_FILENAME="wapiti.out.${sanitized_url::64}.$(date +'%Y_%m_%dT%H_%M_%S').json"
...
#run:
wapiti --scope domain -d 5 -u "${url}" -S insane -f json -o "${OUTPUT_EXPLOITING_FOLDER}/${OUTPUT_FILENAME}"
